-- ============================================================
-- Re-create admin_grant_credits() to ensure it exists in
-- production. Migration 0014 may have been skipped when
-- migrations were applied manually.
--
-- Identical to 0014 in every respect. CREATE OR REPLACE is
