...
import { reportUserAction, type ReportFormState } from "@/app/reports/actions";
...
/** Report-this-user trigger + moderation report modal. */
export function ReportUserDialog({
  ...
  const [state, formAction] = useActionState(reportUserAction, initialState);
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Report user">
        {state.ok ? (
          ...
          <form action={formAction} className="space-y-4" noValidate>
            ...
            <Field
              ...
              hint="Optional. Add anything that helps our team review."
            >
              <Textarea
                id="details"
                name="details"
